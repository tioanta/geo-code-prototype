...
with tab2:
    ...
    top_sent = df_filtered.nlargest(10, 'Sentiment_Score')[['Desa', 'Sentiment_Score', 'Review_Count', 'Sektor_Dominan']]
...
# Footer
st.markdown("---")
st.caption("Geo-Credit Intelligence v5.2 (Performance Optimized)")
